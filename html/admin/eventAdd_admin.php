...
<body class="grey lighten-4">
    ...
    <div class="mainContainer">
        ...
        <div class="formContainer card">
            <form class="col s12 l12 m6" id="eventAdd" name="eventAdd" action="../../php/eventAdd.php" onsubmit="return validateForm()" method="post">

                <div class="row">
                    <div class="input-field col s12">
                        <input id="name" type="text" class="validate" name="Event_Name">
                ...
                <div class="row">
                    <div class="input-field col s6">
                        <input id="ls_query" type="text" class="validate" name="users">
                        <label for="users">Users</label>
                    </div>

                    <div class="input-field col s6">
                        <input id="ls_query_2" type="text" class="validate" name="groups">
