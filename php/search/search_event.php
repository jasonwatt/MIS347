...
if ($_POST) {
    ...
    while ($row = mysql_fetch_array($result)) {
        ...
        <div class="show" align="left">
            <img src="ic_person_black_48dp_1x.PNG" style="width:50px; height:50px; float:left; margin-right:6px;"/><span class="name"><?php echo $final_eventname; ?></span>&nbsp;<br/><?php echo $final_eventid; ?>
            <br/>
        </div>
        <?php
    }
